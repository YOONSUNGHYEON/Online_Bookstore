...
<form action='<c:url value="/Join"/>' method="post" name="join">
    <div id="wrapper">
        ...
        <div class="logo"><a href='<c:url value="/"/>'>RIDIBOOKS</a></div>
            ...
            <div class="birth">
                <h3>생년월일</h3>
                <div class="year_box"><input type="text" placeholder="년(4자)" name="Member_Bir_Y" id="Member_Bir_Y"></div>
                <div class="month_box">
                ...
                <div class="date_box"><input type="text" placeholder="일" name="Member_Bir_D" id="Member_Bir_D"></div>
            </div>
            <div class="gender">
                <h3>성별</h3>
